        ...
        <div className="container flex flex-wrap items-center justify-between">
            <Link href="/" className="navbar-brand md:me-8" >
                <span className="inline-block dark:hidden">
                    <Image width={144} height={30} src="/images/logo-black.png" className="l-dark" alt=""/>
                    <Image width={144} height={30} src="/images/logo-white.png" className="l-light" alt=""/>
                </span>
            ...
            <div className="nav-icons flex items-center lg_992:order-2 ms-auto md:ms-8">
                ...
                <ul className="list-none menu-social mb-0">
                    <li className="inline-flex">
                        ...
                        <Link href="" className="ms-1">
                            <span className="login-btn-primary "><span className="btn btn-icon btn-sm rounded-full bg-amber-500 hover:bg-amber-600 border-amber-500 hover:border-amber-600 text-white"><Unicons.Linkedin width={16}/></span></span>
